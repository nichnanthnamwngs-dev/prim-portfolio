(function () {
  ...
  const copy = {
    th: {
      brandName: 'พริ้ม นิชนันท์', navAbout: 'เกี่ยวกับฉัน', navEducation: 'การศึกษา', navSkills: 'ทักษะ',
      navCertificates: 'ใบรับรอง', navProjects: 'ผลงาน', navContact: 'ติดต่อ',
      heroEyebrow: 'นักศึกษาวิศวกรรมคอมพิวเตอร์ · พร้อมฝึกงาน', heroFirstName: 'พริ้ม', heroLastName: 'นิชนันท์.',
      ...
      aboutLead: 'สวัสดีค่ะ ชื่อพริ้ม—นิชนันท์ นามวงศ์ เป็นนักศึกษาวิศวกรรมคอมพิวเตอร์ที่สนใจทั้งการออกแบบและพัฒนาผลิตภัณฑ์ดิจิทัล',
